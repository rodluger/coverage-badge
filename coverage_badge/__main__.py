...
def get_badge(total, color=DEFAULT_COLOR, name=None):
    """
...
def parse_args(argv=None):
    ...
    parser.add_argument("-n", dest="template_name", help="Template name.")
...
def main(argv=None):
    ...
    badge = get_badge(total, color, name=args.template_name)
